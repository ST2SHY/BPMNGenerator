...
def calculate_bpmn_jaccard_similarity(benchmark_bpmn_xml: str, target_bpmn_xml: str) -> Dict[str, float | str | list]:
    """
...
def save_jaccard_result(result: Dict[str, float | str | list], output_file: Optional[str] = None):
    """
...
def compare_bpmn_models(benchmark_bpmn_file: Optional[str] = None, target_bpmn_file: Optional[str] = None,
                        benchmark_bpmn_xml: Optional[str] = None, target_bpmn_xml: Optional[str] = None) -> Optional[Dict[str, float | str | list]]:
    """
