...
def calculate_bpmn_ssdt_similarity(benchmark_bpmn_xml: str, target_bpmn_xml: str) -> Dict[str, float | str | list]:
    """
...
def save_ssdt_result(result: Dict[str, float | str | list], output_file: Optional[str] = None):
    """
